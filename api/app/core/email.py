"""Email utilities for Overseer API.

Core send_email function lives in shared/email.py (used by both API and Worker).
This module re-exports it and provides API-specific HTML renderers.
"""
from shared.email import send_email  # noqa: F401
